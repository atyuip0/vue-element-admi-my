...
export const asyncRouterMap = [
  {
    ...
    children: [
      { path: 'index', component: _import('goods/index'), name: '商品列表', meta: { title: '商品列表' }},
      { path: 'create', component: _import('goods/create'), name: '商品添加', meta: { title: '商品添加' }},
      { path: 'edit', component: _import('goods/edit'), name: '商品编辑', meta: { title: '商品编辑' }}
    ]
  },
  {
    path: '/category',
    ...
    children: [
      { path: 'index', component: _import('category/index'), name: '分类列表', meta: { title: '分类列表' }},
      { path: 'create', component: _import('category/create'), name: '分类添加', meta: { title: '分类添加' }},
      { path: 'edit', component: _import('category/edit'), name: '分类编辑', meta: { title: '分类编辑' }}
    ]
  },
  {
    path: '/permission',
